...
// No design file for this screen — built to match Login's card shell and
// Checkout's OTP-block pattern (Section 6.4: forgot-password reuses the
// same send/verify OTP pair as COD checkout verification).
export default function ForgotPasswordPage() {
  ...
  function handleSendCode() {
    ...
    setOtpSent(true);
    toast.success("Demo reset code sent — UI-only stub until /backend + MSG91 exist (Section 6.4)");
  }
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-8">
        <div className="w-full max-w-[400px] rounded-[22px] border border-border-pink-light bg-white p-7 shadow-[0_8px_30px_rgba(0,0,0,0.05)]">
          ...
          {!otpSent ? (
            ...
            <>
              <p className="mb-3 text-[12.5px] text-muted">Enter the 4-digit code sent to your number.</p>
